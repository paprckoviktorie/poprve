...
namespace ClassPlayground
{
    ...
    internal class Program
    {
        class Rectangle
        {
            public int heigth; 
            public int width;
            public Rectangle(int heigth, int width)//sem muzu psat int height, int weight a tak //to, co je dole, ale v jednom řádku 
            {
                this.heigth = heigth;
                this.width = width;
            }
            ...
            public string CalculateWidthHeightRatio()
            {
                if (width==heigth)
                {
                    return "Je to čtverec.";
                }
        ...
        class BankAccount
        {
            ...
            {
                balance += amount;
                Console.WriteLine($"Vklad {amount} Kč proběhl úspěšně. Zůstatek je {balance} Kč.");
            }
            public double Withdraw (double amount)
            {
                ...
                { 
                    balance -= amount;
                    Console.WriteLine($"Výběr úspěšný. Nový zůstatek je {balance} Kč.");
                    return amount;
                }
            }

            public void Transfer (double amout, BankAccount, int destinationAccount)
            {
                if (balance < amout)
                {
                ...
                {
                    Withdraw(amount);
                    destinationAccount.Deposit(amout);
                    Console.WriteLine($"Odesíláme částku {amout} na účet {destinationAccount}. ");
                }
            }
        }
        ...
        {
            Rectangle rect = new Rectangle(); //"prázdný kontruktor", pak píšu this.weigth, když je ta proměnná stejně pojmenovaná
           rect.heigth = 10;
           rect.width = 5;
